...
namespace thekogans {
    namespace crypto {
        ...
        #if !defined (THEKOGANS_CRYPTO_MIN_DHE_KEY_EXCHANGE_PARAMS_IN_PAGE)
            #define THEKOGANS_CRYPTO_MIN_DHE_KEY_EXCHANGE_PARAMS_IN_PAGE 16
        #endif // !defined (THEKOGANS_CRYPTO_MIN_DHE_KEY_EXCHANGE_PARAMS_IN_PAGE)
