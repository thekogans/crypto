...
namespace {
    bool TestDHParams (
        ...
        THEKOGANS_UTIL_TRY {
            std::cout << paramsName << "...";
            crypto::EVP_PKEYPtr params2 = crypto::DH::LoadParams (*crypto::DH::SaveParams (params));
            bool result = EVP_PKEY_cmp_parameters (&params, params2.get ()) == 1;
...
namespace {
    bool TestDSAParams (
        ...
        THEKOGANS_UTIL_TRY {
            std::cout << paramsName << "...";
            crypto::EVP_PKEYPtr params2 = crypto::DSA::LoadParams (*crypto::DSA::SaveParams (params));
            bool result = EVP_PKEY_cmp_parameters (&params, params2.get ()) == 1;
            std::cout << (result ? "pass" : "fail") << std::endl;
            return result ;
        }
...
namespace {
    bool TestECParams (
        ...
        THEKOGANS_UTIL_TRY {
            std::cout << paramsName << "...";
            crypto::EVP_PKEYPtr params2 = crypto::EC::LoadParams (*crypto::EC::SaveParams (params));
            bool result = EVP_PKEY_cmp_parameters (&params, params2.get ()) == 1;
            std::cout << (result ? "pass" : "fail") << std::endl;
            return result ;
        }
